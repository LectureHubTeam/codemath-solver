...
def process_problem_batch(
    ...
    # Tạo temporary profile cho worker này
    profile_dir = create_temp_profile()

    # Sử dụng window layout được cung cấp hoặc tính toán mặc định
    ...
    try:
        agent = CodeMathAgent(profile_dir=profile_dir, window_layout=window_layout)
